...
The opt-in `imx6ull-mlp` feature substitutes a fixed-graph FP32 executor for
`.duckmlp` policy files while retaining this control loop; its experimental
i.MX6ULL deployment, constraints and measurements are in
